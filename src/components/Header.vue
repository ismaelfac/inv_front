                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="logo">
                                <a href="/src/assets/website/index.html">
                                    <img src="/src/assets/website/images/logo/logo.png" alt="">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="company-info clearfix">
                                <div class="company-info-item">
                                    <div class="header-icon">
                                        <img src="/src/assets/website/images/icons/phone.png" alt="">
                                    </div>
                                ...
                                <div class="company-info-item">
                                    <div class="header-icon">
                                        <img src="/src/assets/website/images/icons/mail-open.png" alt="">
                                    </div>
                                    <div class="header-info">
                            ...
                            <div class="header-search clearfix">
                                <form action="#">
                                    <button class="search-icon" type="submit">
                                        <img src="/src/assets/website/images/icons/search.png" alt="">
                                    </button>
