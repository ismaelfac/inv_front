        ...
        <div class="slider-1 pos-relative slider-overlay">
            <div class="bend niceties preview-1">
                <div id="ensign-nivoslider-3" class="slides">   
                    <img src="/src/assets/website/images/slider/1.jpg" alt="" title="#slider-direction-1"  />
                    <img src="/src/assets/website/images/slider/2.jpg" alt="" title="#slider-direction-2"  />
                    <img src="/src/assets/website/images/slider/1.jpg" alt="" title="#slider-direction-3"  />
                </div>
                <!-- direction 1 -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="about-image">
                                <a href="about.html"><img src="/src/assets/website/images/about/1.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="service-carousel">
                            ...
                            <div class="col-md-12">
                                <div class="service-item">
                                    <div class="service-item-image">
                                        <a href="service-details.html"><img src="/src/assets/website/images/service/1.jpg" alt=""></a>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="service-item">
                                    <div class="service-item-image">
                                        <a href="service-details.html"><img src="/src/assets/website/images/service/2.jpg" alt=""></a>
                                    </div>
                                    <div class="service-item-info">
                            ...
                            <div class="col-md-12">
                                <div class="service-item">
                                    <div class="service-item-image">
                                        <a href="service-details.html"><img src="/src/assets/website/images/service/3.jpg" alt=""></a>
                                    </div>
                                    <div class="service-item-info">
                            ...
                            <div class="col-md-12">
                                <div class="service-item">
                                    <div class="service-item-image">
                                        <a href="service-details.html"><img src="/src/assets/website/images/service/4.jpg" alt=""></a>
                                    </div>
                                    <div class="service-item-info">
                        ...
                        <div class="col-md-9 col-sm-8 col-xs-12">
                            <div class="booking-conternt clearfix">
                                ...
                                <div class="booking-imgae">
                                    <img src="/src/assets/website/images/others/booking.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="featured-flat">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        ...
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/1.jpg" alt=""></a>
                                        <div class="flat-link">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/2.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        ...
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/3.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/4.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        <span class="for-sale">For Sale</span>
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/5.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/6.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        <span class="for-sale rent">For rent</span>
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/7.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/8.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                            ...
                            <div class="col-md-4 hidden-sm col-xs-12">
                                <div class="flat-item">
                                    <div class="flat-item-image">
                                        <span class="for-sale">For Sale</span>
                                        <a href="properties-details.html"><img src="/src/assets/website/images/flat/9.jpg" alt=""></a>
                                        <div class="flat-link">
                                            <a href="properties-details.html">More Details</a>
                                        </div>
                                        <ul class="flat-desc">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Fully Furnished</h6>
                                                <p>Lorem is a dummy text do eiud tempor dolor sit amet dum</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Royal Touch Paint</h6>
                                                <p>Lorem is a dummy text do eiud tempor dolor sit amet dum</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Latest Interior Design</h6>
                                                <p>Lorem is a dummy text do eiud tempor dolor sit amet dum</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Non Stop Security</h6>
                                                <p>Lorem is a dummy text do eiud tempor dolor sit amet dum</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Living Inside a Nature</h6>
                                                <p>Lorem is a dummy text do eiud tempor dolor sit amet dum</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Luxurious Fittings</h6>
                                                <p>Lorem is a dummy text do eiud tempor dolor sit amet dum</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="agents-carousel">
                                ...
                                <div class="col-md-12">
                                    <div class="single-agent">
                                        <div class="agent-image">
                                            <img src="/src/assets/website/images/agents/1.jpg" alt="">
                                        </div>
                                        ...
                                        <div class="agent-info-hover">
                                            ...
                                            <ul class="agent-address">
                                                <li><img src="/src/assets/website/images/icons/phone-2.png" alt="">+1245  785  659 </li>
                                                <li><img src="/src/assets/website/images/icons/mail-close.png" alt="">eva@gmail.com </li>
                                            </ul>
                                ...
                                <div class="col-md-12">
                                    <div class="single-agent">
                                        <div class="agent-image">
                                            <img src="/src/assets/website/images/agents/2.jpg" alt="">
                                        </div>
                                        <div class="agent-info">
                                            <div class="agent-name">
                                ...
                                <div class="col-md-12">
                                    <div class="single-agent">
                                        <div class="agent-image">
                                            <img src="/src/assets/website/images/agents/3.jpg" alt="">
                                        </div>
                                        <div class="agent-info">
                                            <div class="agent-name">
                                ...
                                <div class="col-md-12">
                                    <div class="single-agent">
                                        <div class="agent-image">
                                            <img src="/src/assets/website/images/agents/4.jpg" alt="">
                                        </div>
                                        <div class="agent-info">
                                            <div class="agent-name">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-3">
                                        <div class="testimonial-image">
                                            <img src="/src/assets/website/images/others/testimonial.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="blog-carousel">
                            ...
                            <div class="col-md-12">
                                <article class="blog-item bg-gray">
                                    <div class="blog-image">
                                        <a href="single-blog.html"><img src="/src/assets/website/images/blog/1.jpg" alt=""></a>
                                    </div>
                                    <div class="blog-info">
                            ...
                            <div class="col-md-12">
                                <article class="blog-item bg-gray">
                                    <div class="blog-image">
                                        <a href="single-blog.html"><img src="/src/assets/website/images/blog/2.jpg" alt=""></a>
                                    </div>
                                    <div class="blog-info">
                                        <div class="post-title-time">
                            ...
                            <div class="col-md-12">
                                <article class="blog-item bg-gray">
                                    <div class="blog-image">
                                        <a href="single-blog.html"><img src="/src/assets/website/images/blog/3.jpg" alt=""></a>
                                    </div>
                                    <div class="blog-info">
                                        <div class="post-title-time">
                        ...
                        <div class="brand-carousel">
                            ...
                            <div class="col-md-12">
                                <div class="brand-item">
                                    <img src="/src/assets/website/images/brand/1.png" alt="">
                                </div>
                            </div>
                            <!-- brand-item -->
                            <div class="col-md-12">
                                <div class="brand-item">
                                    <img src="/src/assets/website/images/brand/2.png" alt="">
                                </div>
                            </div>
                            <!-- brand-item -->
                            <div class="col-md-12">
                                <div class="brand-item">
                                    <img src="/src/assets/website/images/brand/3.png" alt="">
                                </div>
                            </div>
                            <!-- brand-item -->
                            <div class="col-md-12">
                                <div class="brand-item">
                                    <img src="/src/assets/website/images/brand/4.png" alt="">
                                </div>
                            </div>
                            <!-- brand-item -->
                            <div class="col-md-12">
                                <div class="brand-item">
                                    <img src="/src/assets/website/images/brand/5.png" alt="">
                                </div>
                            </div>
                            <!-- brand-item -->
                            <div class="col-md-12">
