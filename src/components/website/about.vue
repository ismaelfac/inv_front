                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-pull-6 col-xs-12">
                            <div class="about-image">
                                <img src="/src/assets/website/images/about/3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Arriendos</h6>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Ventas</h6>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Asesoría Inmobiliaria</h6>
                                                <p>Profesionales especializados en brindar el acompañamiento necesario para ejecutar con éxito su proyecto inmobiliario.</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Adecuación de Locales Comerciales</h6>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Marketing</h6>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-4">
                                            <div class="features-include-list">
                                                <h6><img src="/src/assets/website/images/icons/7.png" alt="">Publicación de su Inmueble</h6>
                                ...
                                <div class="col-md-12">
                                    <div class="single-agent">
                                        <div class="agent-image">
                                            <img src="/src/assets/website/images/agents/eliana_robles.jpg" alt="">
                                        </div>
                                        ...
                                        <div class="agent-info-hover">
                                            ...
                                            <ul class="agent-address">
                                                <li><img src="/src/assets/website/images/icons/phone-2.png" alt="">+311 6676767</li>
                                                <li><img src="/src/assets/website/images/icons/mail-close.png" alt="">directora<br>@inversionesyproyectos.com</li>
                                            </ul>
