                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 col-sm-5 col-xs-12">
                            <div class="about-image mt-100">
                                <img src="/src/assets/website/images/brand/asesoria_inmobiliaria.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-pull-6 col-xs-12">
                            <div class="about-image">
                                <img src="/src/assets/website/images/brand/rankings.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="about-sheltek-area ptb-115">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-pull-6 col-xs-12">
                            <div class="about-image">
                                <img src="/src/assets/website/images/brand/boletin_semanal.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
